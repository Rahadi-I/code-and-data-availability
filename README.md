# Geometry should guide, not generate — code and data availability

Code, result tables and figures for the manuscript
*"Geometry should guide, not generate: calibrated nearest-neighbour oversampling for imbalanced time series"* (Rahadi et al., in preparation).
...
## Citation
Rahadi, I. et al. Geometry should guide, not generate: calibrated nearest-neighbour oversampling for imbalanced time series. In preparation, 2026.
